app.service('CurrentServices', ['$http', '$q', function($http, $q) {
  ...
  */
  function getUAAToken () {
      ...
      var urlUAA = 'https://beec4981-ddf2-4e97-8c45-01f6970ed96c.predix-uaa.run.aws-usw02-pr.ice.predix.io/oauth/token?grant_type=client_credentials';
      // Ajax call to get UAA Access Token.
      $http({
            method: 'GET',
            url: urlUAA,
            headers: {'Authorization': 'Basic aWVfcGFydG5lcnMuZGV2ZWxvcDppZV9wYXJ0bmVycy5kZXZlbG9w'},
            timeout: 30000,
            cache: false
        })
  ...
  */
  function getV2UAAToken() {
      var deferred = $q.defer();
      // Below will be your UAA url.
      var v2UrlUAA = 'https://beec4981-ddf2-4e97-8c45-01f6970ed96c.predix-uaa.run.aws-usw02-pr.ice.predix.io/oauth/token?grant_type=client_credentials';
      // Ajax call to get UAA Access Token.
      $http({
            method: 'GET',
            url: v2UrlUAA,
  ...
  */
  function getEnvOccupancy (uaaToken, startTime, endTime, size) {
      ...
      var envUrl = 'https://ie-enterprise-analytics-ips-stage.run.aws-usw02-pr.ice.predix.io/enterprise/environment/locations/location_ENV_001_002/latestEvent';

      // Your env api predix zone id.
      var envPredixZoneId = 'ie_partners-IE-ENVIRONMENTAL';
      var deferred = $q.defer();
  ...
  */
  function getHistoricalPath (uaaToken, startTime, endTime) {
      ...
      var positioningPredixZoneId = 'ie_partners-IE-ENVIRONMENTAL';
      var deferred = $q.defer();
  ...
  */
  function getHistoricalPosition (uaaToken, startTime, endTime) {
      ...
      var positioningUrl = 'https://ie-enterprise-analytics-ips-stage.run.aws-usw02-pr.ice.predix.io/enterprise/environment/locations/location_ENV_001_002/latestEvent';
